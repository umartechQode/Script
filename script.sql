...
CREATE TABLE [PurchaseInvoiceActions] (
    [Id] uniqueidentifier NOT NULL,
    [ProcessId] uniqueidentifier NOT NULL,
    ...
    [ModifiedById] nvarchar(max) NULL,
    [ModifiedOn] datetime2 NOT NULL DEFAULT (GetUtcDate()),
    CONSTRAINT [PK_PurchaseInvoiceActions] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_PurchaseInvoiceActions_Companies_CompanyId] FOREIGN KEY ([CompanyId]) REFERENCES [Companies] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_PurchaseInvoiceActions_CompanyProcess_ProcessId] FOREIGN KEY ([ProcessId]) REFERENCES [CompanyProcess] ([Id]) ON DELETE CASCADE,
    CONSTRAINT [FK_PurchaseInvoiceActions_Purchases_PurchaseInvoiceId] FOREIGN KEY ([PurchaseInvoiceId]) REFERENCES [Purchases] ([Id]) ON DELETE NO ACTION
);

GO

CREATE TABLE [PurchaseInvoiceAttachments] (
    [Id] uniqueidentifier NOT NULL,
    [Path] nvarchar(max) NULL,
    [Description] nvarchar(max) NULL,
    [Date] datetime2 NULL,
    ...
    [ModifiedById] nvarchar(max) NULL,
    [ModifiedOn] datetime2 NOT NULL DEFAULT (GetUtcDate()),
    CONSTRAINT [PK_PurchaseInvoiceAttachments] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_PurchaseInvoiceAttachments_Companies_CompanyId] FOREIGN KEY ([CompanyId]) REFERENCES [Companies] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_PurchaseInvoiceAttachments_Purchases_PurchaseInvoiceId] FOREIGN KEY ([PurchaseInvoiceId]) REFERENCES [Purchases] ([Id]) ON DELETE NO ACTION
);

GO

UPDATE [Companies] SET [CreatedDate] = '2021-12-04T10:25:06.0910763Z'
WHERE [Id] = '5f8d5614-2c7e-4ec0-868c-d254e6516b4d';
SELECT @@ROWCOUNT;
...
CREATE INDEX [IX_PurchaseInvoiceActions_CompanyId] ON [PurchaseInvoiceActions] ([CompanyId]);

GO

CREATE INDEX [IX_PurchaseInvoiceActions_ProcessId] ON [PurchaseInvoiceActions] ([ProcessId]);

GO

CREATE INDEX [IX_PurchaseInvoiceActions_PurchaseInvoiceId] ON [PurchaseInvoiceActions] ([PurchaseInvoiceId]);

GO

CREATE INDEX [IX_PurchaseInvoiceAttachments_CompanyId] ON [PurchaseInvoiceAttachments] ([CompanyId]);

GO

CREATE INDEX [IX_PurchaseInvoiceAttachments_PurchaseInvoiceId] ON [PurchaseInvoiceAttachments] ([PurchaseInvoiceId]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211204102508_purchaseinvoice-action-attachment-db', N'2.2.6-servicing-10079');

GO

ALTER TABLE [PurchaseInvoiceAttachments] ADD [PurchaseInvoicePostId] uniqueidentifier NULL;

GO

ALTER TABLE [PurchaseInvoiceActions] ADD [PurchaseInvoicePostId] uniqueidentifier NULL;

GO

UPDATE [Companies] SET [CreatedDate] = '2021-12-04T12:45:55.6537035Z'
WHERE [Id] = '5f8d5614-2c7e-4ec0-868c-d254e6516b4d';
SELECT @@ROWCOUNT;
...
CREATE INDEX [IX_PurchaseInvoiceAttachments_PurchaseInvoicePostId] ON [PurchaseInvoiceAttachments] ([PurchaseInvoicePostId]);

GO

CREATE INDEX [IX_PurchaseInvoiceActions_PurchaseInvoicePostId] ON [PurchaseInvoiceActions] ([PurchaseInvoicePostId]);

GO

ALTER TABLE [PurchaseInvoiceActions] ADD CONSTRAINT [FK_PurchaseInvoiceActions_PurchasePosts_PurchaseInvoicePostId] FOREIGN KEY ([PurchaseInvoicePostId]) REFERENCES [PurchasePosts] ([Id]) ON DELETE NO ACTION;

GO

ALTER TABLE [PurchaseInvoiceAttachments] ADD CONSTRAINT [FK_PurchaseInvoiceAttachments_PurchasePosts_PurchaseInvoicePostId] FOREIGN KEY ([PurchaseInvoicePostId]) REFERENCES [PurchasePosts] ([Id]) ON DELETE NO ACTION;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211204124557_purchaseinvoicepost-relationwith-action-attachment-db', N'2.2.6-servicing-10079');
...
CREATE TABLE [PurchaseOrderPayments] (
    ...
    [Date] datetime2 NOT NULL,
    [VoucherNumber] nvarchar(max) NULL,
    [PaymentOption] nvarchar(max) NULL,
    [ChequeNumber] nvarchar(max) NULL,
    [Amount] decimal(18,2) NOT NULL,
    [Narration] nvarchar(max) NULL,
    [PurchaseOrderId] uniqueidentifier NULL,
    ...
    CONSTRAINT [FK_PurchaseOrderPayments_Companies_CompanyId] FOREIGN KEY ([CompanyId]) REFERENCES [Companies] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_PurchaseOrderPayments_PaymentVouchers_PaymentVoucherId] FOREIGN KEY ([PaymentVoucherId]) REFERENCES [PaymentVouchers] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_PurchaseOrderPayments_PurchaseOrders_PurchaseOrderId] FOREIGN KEY ([PurchaseOrderId]) REFERENCES [PurchaseOrders] ([Id]) ON DELETE NO ACTION
);

GO

UPDATE [Companies] SET [CreatedDate] = '2021-12-06T12:44:26.5428372Z'
WHERE [Id] = '5f8d5614-2c7e-4ec0-868c-d254e6516b4d';
SELECT @@ROWCOUNT;
...
CREATE INDEX [IX_PurchaseOrderPayments_CompanyId] ON [PurchaseOrderPayments] ([CompanyId]);

GO

CREATE INDEX [IX_PurchaseOrderPayments_PaymentVoucherId] ON [PurchaseOrderPayments] ([PaymentVoucherId]);
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211206124428_purchase-order-payment-db', N'2.2.6-servicing-10079');
...
FROM [sys].[default_constraints] [d]
INNER JOIN [sys].[columns] [c] ON [d].[parent_column_id] = [c].[column_id] AND [d].[parent_object_id] = [c].[object_id]
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[PurchaseOrderPayments]') AND [c].[name] = N'PaymentOption');
IF @var49 IS NOT NULL EXEC(N'ALTER TABLE [PurchaseOrderPayments] DROP CONSTRAINT [' + @var49 + '];');
ALTER TABLE [PurchaseOrderPayments] DROP COLUMN [PaymentOption];

GO

ALTER TABLE [PurchaseOrderPayments] ADD [PaymentMethod] int NOT NULL DEFAULT 0;

GO

ALTER TABLE [PurchaseOrderPayments] ADD [PaymentMode] int NOT NULL DEFAULT 0;

GO

UPDATE [Companies] SET [CreatedDate] = '2021-12-07T07:40:32.8932541Z'
WHERE [Id] = '5f8d5614-2c7e-4ec0-868c-d254e6516b4d';
SELECT @@ROWCOUNT;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211207074035_payment-mode-in-purchaseorder-payment', N'2.2.6-servicing-10079');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211210073847_invoice-print-setting-english-arabic', N'2.2.6-servicing-10079');
...
CREATE TABLE [ExpenseTypes] (
    ...
    [ExpenseTypeArabic] nvarchar(max) NULL,
    [Status] bit NOT NULL,
    [CompanyId] uniqueidentifier NOT NULL,
    [CreatedById] nvarchar(max) NULL,
    [CreatedOn] datetime2 NOT NULL DEFAULT (GetUtcDate()),
    ...
    CONSTRAINT [FK_ExpenseTypes_Companies_CompanyId] FOREIGN KEY ([CompanyId]) REFERENCES [Companies] ([Id]) ON DELETE NO ACTION
);

GO

CREATE TABLE [PurchaseOrderExpense] (
    [Id] uniqueidentifier NOT NULL,
    ...
    [ModifiedById] nvarchar(max) NULL,
    [ModifiedOn] datetime2 NOT NULL DEFAULT (GetUtcDate()),
    CONSTRAINT [PK_PurchaseOrderExpense] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_PurchaseOrderExpense_Companies_CompanyId] FOREIGN KEY ([CompanyId]) REFERENCES [Companies] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_PurchaseOrderExpense_ExpenseTypes_ExpenseTypeId] FOREIGN KEY ([ExpenseTypeId]) REFERENCES [ExpenseTypes] ([Id]) ON DELETE NO ACTION
);

GO

UPDATE [Companies] SET [CreatedDate] = '2021-12-10T12:10:41.5554454Z'
WHERE [Id] = '5f8d5614-2c7e-4ec0-868c-d254e6516b4d';
SELECT @@ROWCOUNT;
...
CREATE INDEX [IX_PurchaseOrderExpense_CompanyId] ON [PurchaseOrderExpense] ([CompanyId]);

GO

CREATE INDEX [IX_PurchaseOrderExpense_ExpenseTypeId] ON [PurchaseOrderExpense] ([ExpenseTypeId]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211210121043_expenseType-Db', N'2.2.6-servicing-10079');

GO

ALTER TABLE [Companies] ADD [SimpleInvoice] bit NOT NULL DEFAULT 0;

GO

UPDATE [Companies] SET [CreatedDate] = '2021-12-10T14:07:44.6191358Z'
WHERE [Id] = '5f8d5614-2c7e-4ec0-868c-d254e6516b4d';
SELECT @@ROWCOUNT;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211210140747_simple-invoice-in-company-db', N'2.2.6-servicing-10079');

GO

ALTER TABLE [PurchaseOrderExpense] ADD [Amount] decimal(18,2) NOT NULL DEFAULT 0.0;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [ApprovalStatus] int NOT NULL DEFAULT 0;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [ApprovedBy] nvarchar(max) NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [ApprovedDate] datetime2 NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [BankCashAccountId] uniqueidentifier NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';

GO

ALTER TABLE [PurchaseOrderExpense] ADD [ChequeNumber] nvarchar(max) NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [ContactAccountId] uniqueidentifier NOT NULL DEFAULT '00000000-0000-0000-0000-000000000000';

GO

ALTER TABLE [PurchaseOrderExpense] ADD [Date] datetime2 NOT NULL DEFAULT '0001-01-01T00:00:00.0000000';

GO

ALTER TABLE [PurchaseOrderExpense] ADD [DraftBy] nvarchar(max) NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [DraftDate] datetime2 NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [Narration] nvarchar(max) NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [PaymentMethod] int NOT NULL DEFAULT 0;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [PaymentMode] int NOT NULL DEFAULT 0;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [PaymentVoucherType] int NOT NULL DEFAULT 0;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [PettyCash] int NOT NULL DEFAULT 0;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [PurchaseOrderId] uniqueidentifier NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [Reason] nvarchar(max) NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [RejectBy] nvarchar(max) NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [RejectDate] datetime2 NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [VoidBy] nvarchar(max) NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [VoidDate] datetime2 NULL;

GO

ALTER TABLE [PurchaseOrderExpense] ADD [VoucherNumber] nvarchar(max) NULL;

GO

ALTER TABLE [PaymentVoucherAttachments] ADD [PurchaseOrderExpenseId] uniqueidentifier NULL;

GO

UPDATE [Companies] SET [CreatedDate] = '2021-12-11T09:55:11.0471523Z'
WHERE [Id] = '5f8d5614-2c7e-4ec0-868c-d254e6516b4d';
SELECT @@ROWCOUNT;
...
CREATE INDEX [IX_PurchaseOrderExpense_BankCashAccountId] ON [PurchaseOrderExpense] ([BankCashAccountId]);

GO

CREATE INDEX [IX_PurchaseOrderExpense_ContactAccountId] ON [PurchaseOrderExpense] ([ContactAccountId]);

GO

CREATE INDEX [IX_PurchaseOrderExpense_PurchaseOrderId] ON [PurchaseOrderExpense] ([PurchaseOrderId]);

GO

CREATE INDEX [IX_PaymentVoucherAttachments_PurchaseOrderExpenseId] ON [PaymentVoucherAttachments] ([PurchaseOrderExpenseId]);

GO

ALTER TABLE [PaymentVoucherAttachments] ADD CONSTRAINT [FK_PaymentVoucherAttachments_PurchaseOrderExpense_PurchaseOrderExpenseId] FOREIGN KEY ([PurchaseOrderExpenseId]) REFERENCES [PurchaseOrderExpense] ([Id]) ON DELETE NO ACTION;

GO

ALTER TABLE [PurchaseOrderExpense] ADD CONSTRAINT [FK_PurchaseOrderExpense_Accounts_BankCashAccountId] FOREIGN KEY ([BankCashAccountId]) REFERENCES [Accounts] ([Id]) ON DELETE NO ACTION;

GO

ALTER TABLE [PurchaseOrderExpense] ADD CONSTRAINT [FK_PurchaseOrderExpense_Accounts_ContactAccountId] FOREIGN KEY ([ContactAccountId]) REFERENCES [Accounts] ([Id]) ON DELETE NO ACTION;

GO

ALTER TABLE [PurchaseOrderExpense] ADD CONSTRAINT [FK_PurchaseOrderExpense_PurchaseOrders_PurchaseOrderId] FOREIGN KEY ([PurchaseOrderId]) REFERENCES [PurchaseOrders] ([Id]) ON DELETE NO ACTION;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211211095513_purchaseOrder-expense', N'2.2.6-servicing-10079');

GO

ALTER TABLE [SaleOrders] ADD [WareHouseId] uniqueidentifier NULL;

GO

ALTER TABLE [SaleOrderItems] ADD [WareHouseId] uniqueidentifier NULL;

GO

UPDATE [Companies] SET [CreatedDate] = '2021-12-11T11:38:06.3920209Z'
WHERE [Id] = '5f8d5614-2c7e-4ec0-868c-d254e6516b4d';
SELECT @@ROWCOUNT;
...
ALTER TABLE [SaleOrderItems] ADD CONSTRAINT [FK_SaleOrderItems_Warehouses_WareHouseId] FOREIGN KEY ([WareHouseId]) REFERENCES [Warehouses] ([Id]) ON DELETE NO ACTION;

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211211113809_warehouse-in-saleorder-db', N'2.2.6-servicing-10079');

GO

ALTER TABLE [Companies] ADD [SoInventoryReserve] bit NOT NULL DEFAULT 0;

GO

UPDATE [Companies] SET [CreatedDate] = '2021-12-11T12:32:52.1657044Z'
WHERE [Id] = '5f8d5614-2c7e-4ec0-868c-d254e6516b4d';
SELECT @@ROWCOUNT;
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211211123254_saleorder-inventory-reserve-db', N'2.2.6-servicing-10079');
...
CREATE TABLE [SaleOrderPayments] (
    ...
    [ModifiedById] nvarchar(max) NULL,
    [ModifiedOn] datetime2 NOT NULL DEFAULT (GetUtcDate()),
    CONSTRAINT [PK_SaleOrderPayments] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_SaleOrderPayments_Companies_CompanyId] FOREIGN KEY ([CompanyId]) REFERENCES [Companies] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_SaleOrderPayments_PaymentVouchers_PaymentVoucherId] FOREIGN KEY ([PaymentVoucherId]) REFERENCES [PaymentVouchers] ([Id]) ON DELETE NO ACTION,
    CONSTRAINT [FK_SaleOrderPayments_SaleOrders_SaleOrderId] FOREIGN KEY ([SaleOrderId]) REFERENCES [SaleOrders] ([Id]) ON DELETE NO ACTION
);

GO

UPDATE [Companies] SET [CreatedDate] = '2021-12-11T15:16:03.9724392Z'
WHERE [Id] = '5f8d5614-2c7e-4ec0-868c-d254e6516b4d';
SELECT @@ROWCOUNT;
...
CREATE INDEX [IX_SaleOrderPayments_CompanyId] ON [SaleOrderPayments] ([CompanyId]);

GO

CREATE INDEX [IX_SaleOrderPayments_PaymentVoucherId] ON [SaleOrderPayments] ([PaymentVoucherId]);

GO

CREATE INDEX [IX_SaleOrderPayments_SaleOrderId] ON [SaleOrderPayments] ([SaleOrderId]);

GO

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20211211151606_saleorder-payment-db', N'2.2.6-servicing-10079');
